...
static FG_Controller *FG_Controller_FG_Controller
  (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance, FG_Controller *obj);
static boolean_T isequal(real_T varargin_1, real_T varargin_2);
static void FG_Controller_stepImpl(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
...
static void Construct_Data(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  ...
  *Data_dq_toe_L, real_T Data_qall[20], real_T Data_dqall[20], real_T Data_qq[4],
  ...
  Data_dqjL[2], real_T Data_dqsL[2], real_T Data_u_P[10], real_T Data_u_D[10],
  real_T *Data_computer_time);
static void RadioChannelToButton(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
...
static real_T first_order_filter(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, real_T prev, real_T new, real_T para);
static real_T median(real_T x[3]);
static void IMU_to_Euler_v2(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, const emlrtStack *sp, real_T b_q[4], real_T w[3], real_T *yaw,
  real_T *pitch, real_T *roll, real_T *dyaw, real_T *dpitch, real_T *droll);
static void error(const emlrtStack *sp);
static void b_error(const emlrtStack *sp);
static void c_error(const emlrtStack *sp);
static void getSpringDeflectionAngle(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, real_T knee_motor, real_T knee_joint, real_T ankle_joint,
  real_T qs[2]);
static void getSpringDeflectionRate(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, real_T knee_motor, real_T knee_joint, real_T ankle_joint,
  real_T dqs[2]);
static void FG_Controller_get_FK(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, const emlrtStack *sp, real_T b_hd_joint[10], real_T
  b_dhd_joint[10], real_T hd_output[10], real_T dhd_output[10]);
static void Forward_Kinematics_p(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, const emlrtStack *sp, real_T qFlexion, real_T qKnee, real_T
  *LA, real_T *LL);
static void d_error(const emlrtStack *sp);
static void Forward_Kinematics_v(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
...
static void FG_Controller_get_GRF(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
...
static void FG_Controller_get_s_LR(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, FG_Controller *obj, real_T GRF_v[2], real_T *s_L, real_T *s_R);
static void FG_Controller_ControlPolicy(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
...
static real_T bezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
...
static real_T dbezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
                      const emlrtStack *sp, real_T b_s);
static real_T b_bezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  const emlrtStack *sp, real_T coeff[21], real_T b_s);
static real_T c_bezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  const emlrtStack *sp, real_T coeff[6], real_T b_s);
static real_T singleterm_bezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, const emlrtStack *sp, real_T k, real_T b_s);
static real_T b_dbezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  const emlrtStack *sp, real_T b_s);
static real_T d_bezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  const emlrtStack *sp, real_T coeff[5], real_T b_s);
static real_T b_singleterm_bezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, const emlrtStack *sp, real_T k, real_T b_s);
static real_T c_dbezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  const emlrtStack *sp, real_T coeff[6], real_T b_s);
static real_T d_dbezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  const emlrtStack *sp, real_T coeff[22], real_T b_s);
static void FG_Controller_get_velocity_v3(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *
...
static void Rz(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance, real_T
               b_theta, real_T R[9]);
static void get_feet_velocity(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, real_T b_q[20], real_T b_dq[20], real_T b_l_foot_v[3], real_T
  b_r_foot_v[3]);
static void get_feet_position(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, real_T b_q[20], real_T b_l_foot_p[3], real_T b_r_foot_p[3]);
static void ComPosition(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  real_T var1[20], real_T output1[3]);
static void ComVelocity(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
  real_T var1[20], real_T var2[20], real_T output1[3]);
static void e_bezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
                     const emlrtStack *sp, real_T coeff[60], real_T b_s, real_T
                     fcn[10]);
static void e_dbezier(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
                      const emlrtStack *sp, real_T coeff[60], real_T b_s, real_T
                      fcn[10]);
static real_T wrap2Pi(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance,
                      real_T angle);
static void FG_Controller_get_IK(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, const emlrtStack *sp, real_T hd_output[10], real_T
  dhd_output[10], real_T b_hd_joint[10], real_T b_dhd_joint[10]);
static void Inverse_Kinematics_p(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, const emlrtStack *sp, real_T LA, real_T LL, real_T *qFlexion,
  real_T *qKnee);
static void Inverse_Kinematics_v(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, const emlrtStack *sp, real_T LL, real_T dLA, real_T dLL,
  real_T *dqFlexion, real_T *dqKnee);
static void clamp(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance, real_T
                  a[2], real_T lim1, real_T lim2, real_T b[2]);
static void vector_saturate(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance, real_T b_u[10], real_T b1[10], real_T b2[10], real_T b_u_sat
  [10]);
...
static void cgxe_mdl_start(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance);
static const mxArray *emlrt_marshallOut(const int32_T b_u);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
...
static void b_FG_Controller_FG_Controller(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *
  moduleInstance, FG_Controller **obj);
static void init_simulink_io_address(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG
  *moduleInstance);
  ...
  real_T *Data_computer_time)
{
  ...
  real_T b_qall[20];
  real_T b_dqall[20];
  static int8_T iv0[6] = { 2, 3, 4, 7, 8, 9 };
      ...
      (moduleInstance->covInst_CONTAINER_BLOCK_INDEX, 0, 0, 9, obj->begin == 1.0))
  {
    ...
    if (covrtLogIf(moduleInstance->covInst_CONTAINER_BLOCK_INDEX, 0, 0, 9,
      ...
      for (i = 0; i < 6; i++) {
        obj->dh0_joint[iv0[i]] = b_encoder_fil[iv0[i]];
      }
    }
...
static void error(const emlrtStack *sp)
{
  ...
  emlrtInitCharArrayR2013a(sp, 31, m0, &b_u[0]);
  emlrtAssign(&b_y, m0);
  st.site = &vk_emlrtRSI;
...
static void b_error(const emlrtStack *sp)
{
  ...
  emlrtInitCharArrayR2013a(sp, 30, m1, &b_u[0]);
  emlrtAssign(&b_y, m1);
  c_y = NULL;
...
static void warning(const emlrtStack *sp)
{
  ...
  emlrtInitCharArrayR2013a(sp, 7, m4, &c_u[0]);
  emlrtAssign(&c_y, m4);
  d_y = NULL;
...
static void mpower(const emlrtStack *sp, real_T a[4], real_T c[4])
{
  ...
  if ((r == 0.0) || (b_t == 0.0) || (rc == 0.0)) {
    ...
    if (rc < 2.2204460492503131E-16) {
      ...
      emlrtInitCharArrayR2013a(&f_st, 6, m5, &rfmt[0]);
      emlrtAssign(&b_y, m5);
      c_y = NULL;
...
static void b_warning(const emlrtStack *sp, char_T varargin_1[14])
{
  ...
  emlrtInitCharArrayR2013a(sp, 7, m6, &c_u[0]);
  emlrtAssign(&c_y, m6);
  d_y = NULL;
  ...
  emlrtInitCharArrayR2013a(sp, 14, m6, &varargin_1[0]);
  emlrtAssign(&e_y, m6);
  st.site = &xk_emlrtRSI;
...
static void e_error(const emlrtStack *sp)
{
  ...
  emlrtInitCharArrayR2013a(sp, 35, m7, &b_u[0]);
  emlrtAssign(&b_y, m7);
  st.site = &vk_emlrtRSI;
  g_error(&st, b_message(&st, b_y, &b_emlrtMCI), &b_emlrtMCI);
}
...
static void f_error(const emlrtStack *sp)
{
  ...
  emlrtInitCharArrayR2013a(sp, 27, m8, &b_u[0]);
  emlrtAssign(&b_y, m8);
  st.site = &vk_emlrtRSI;
  g_error(&st, b_message(&st, b_y, &b_emlrtMCI), &b_emlrtMCI);
}
...
static void c_warning(const emlrtStack *sp)
{
  ...
  const mxArray *d_y;
  static const int32_T iv20[2] = { 1, 38 };
  ...
  emlrtInitCharArrayR2013a(sp, 7, m9, &c_u[0]);
  emlrtAssign(&c_y, m9);
  d_y = NULL;
  m9 = emlrtCreateCharArray(2, iv20);
  emlrtInitCharArrayR2013a(sp, 38, m9, &msgID[0]);
  emlrtAssign(&d_y, m9);
  st.site = &xk_emlrtRSI;
  b_feval(&st, b_y, feval(&st, c_y, d_y, &c_emlrtMCI), &d_emlrtMCI);
}
  ...
  *moduleInstance, const emlrtStack *sp, real_T k, real_T b_s)
{
  ...
  if (covrtLogIf(moduleInstance->covInst_CONTAINER_BLOCK_INDEX, 15, 0, 0, k ==
    ...
    if (!p) {
      ...
      emlrtInitCharArrayR2013a(&st, 27, m10, &b_u[0]);
      emlrtAssign(&c_y, m10);
  ...
  real_T b_dq[20], real_T *dqx, real_T *dqy, real_T *dqz)
{
  ...
  if ((absx11 == 0.0) || (absx21 == 0.0) || (absx31 == 0.0)) {
    ...
    if (absx31 < 2.2204460492503131E-16) {
      ...
      emlrtInitCharArrayR2013a(&g_st, 6, m12, &rfmt[0]);
      emlrtAssign(&b_y, m12);
      c_y = NULL;
      m12 = emlrtCreateDoubleScalar(absx31);
      emlrtAssign(&c_y, m12);
...
static void cgxe_mdl_start(InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance)
{
  ...
  emlrtAssignP(&b_eml_mx, m13);
  m13 = emlrtCreateCharArray(2, iv26);
  emlrtAssignP(&eml_mx, m13);
  ...
  if (moduleInstance->sysobj.isInitialized != 0) {
    b_y = NULL;
    m13 = emlrtCreateCharArray(2, iv27);
    emlrtInitCharArrayR2013a(&b_st, 51, m13, &b_u[0]);
    emlrtAssign(&b_y, m13);
    c_y = NULL;
    m13 = emlrtCreateCharArray(2, iv28);
    emlrtInitCharArrayR2013a(&b_st, 5, m13, &c_u[0]);
    emlrtAssign(&c_y, m13);
  ...
  if (obj->TunablePropsChanged) {
    b_y = NULL;
    m13 = emlrtCreateCharArray(2, iv29);
    emlrtInitCharArrayR2013a(&c_st, 44, m13, &d_u[0]);
    emlrtAssign(&b_y, m13);
  ...
  *moduleInstance)
{
  ...
  if (moduleInstance->sysobj.isInitialized == 2) {
    ...
    emlrtInitCharArrayR2013a(&b_st, 45, m14, &b_u[0]);
    emlrtAssign(&b_y, m14);
    c_y = NULL;
    m14 = emlrtCreateCharArray(2, iv32);
    emlrtInitCharArrayR2013a(&b_st, 5, m14, &d_u[0]);
    emlrtAssign(&c_y, m14);
    g_error(&b_st, message(&b_st, b_y, c_y, &emlrtMCI), &emlrtMCI);
  }
  ...
  if ((int32_T)tunablePropChangedBeforeResetImpl != (int32_T)
    ...
    emlrtInitCharArrayR2013a(&b_st, 44, m14, &c_u[0]);
    emlrtAssign(&b_y, m14);
  ...
  *moduleInstance)
{
  ...
  for (i15 = 0; i15 < 540; i15++) {
    varargin_64_RightStance_HAlpha[i15] = ((real_T *)&((char_T *)(RightStance *)
      &((char_T *)moduleInstance->u3)[0])[0])[i15];
    varargin_64_LeftStance_HAlpha[i15] = ((real_T *)&((char_T *)(LeftStance *)
      &((char_T *)moduleInstance->u3)[4320])[0])[i15];
  }
  ...
  if (obj->isInitialized != 1) {
    ...
    if (obj->isInitialized != 0) {
      ...
      emlrtInitCharArrayR2013a(&d_st, 51, m15, &d_u[0]);
      emlrtAssign(&b_y, m15);
      c_y = NULL;
      m15 = emlrtCreateCharArray(2, iv36);
      emlrtInitCharArrayR2013a(&d_st, 5, m15, &e_u[0]);
      emlrtAssign(&c_y, m15);
    ...
    if (obj->TunablePropsChanged) {
      b_y = NULL;
      m15 = emlrtCreateCharArray(2, iv38);
      emlrtInitCharArrayR2013a(&e_st, 44, m15, &f_u[0]);
      emlrtAssign(&b_y, m15);
  ...
  if (obj->TunablePropsChanged) {
    ...
    emlrtInitCharArrayR2013a(&c_st, 44, m15, &f_u[0]);
    emlrtAssign(&b_y, m15);
    g_error(&c_st, b_message(&c_st, b_y, &emlrtMCI), &emlrtMCI);
  }
  ...
  *moduleInstance)
{
  ...
  if (moduleInstance->sysobj.isInitialized == 2) {
    b_y = NULL;
    m16 = emlrtCreateCharArray(2, iv39);
    emlrtInitCharArrayR2013a(&b_st, 45, m16, &b_u[0]);
    emlrtAssign(&b_y, m16);
    c_y = NULL;
    m16 = emlrtCreateCharArray(2, iv40);
    emlrtInitCharArrayR2013a(&b_st, 8, m16, &c_u[0]);
    emlrtAssign(&c_y, m16);
    g_error(&b_st, message(&b_st, b_y, c_y, &emlrtMCI), &emlrtMCI);
  }
  ...
  if (flag) {
    ...
    if (moduleInstance->sysobj.isInitialized == 2) {
      b_y = NULL;
      m16 = emlrtCreateCharArray(2, iv41);
      emlrtInitCharArrayR2013a(&b_st, 45, m16, &b_u[0]);
      emlrtAssign(&b_y, m16);
      c_y = NULL;
      m16 = emlrtCreateCharArray(2, iv42);
...
static const mxArray *emlrt_marshallOut(const int32_T b_u)
{
  ...
  *(int32_T *)emlrtMxGetData(m17) = b_u;
  emlrtAssign(&b_y, m17);
  return b_y;
}
  ...
  (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance)
{
  ...
  d_y = NULL;
  m18 = emlrtCreateLogicalScalar(moduleInstance->sysobj.TunablePropsChanged);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "TunablePropsChanged", d_y, 1);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_pitch);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_pitch", d_y, 2);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_pitch);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_pitch", d_y, 3);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_roll);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_roll", d_y, 4);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_roll);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_roll", d_y, 5);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_yaw);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_yaw", d_y, 6);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_yaw);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_yaw", d_y, 7);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_abduction);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_abduction", d_y, 8);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_rotation);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_rotation", d_y, 9);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_thigh);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_thigh", d_y, 10);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_knee);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_knee", d_y, 11);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_toe);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_toe", d_y, 12);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_abduction);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_abduction", d_y, 13);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_rotation);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_rotation", d_y, 14);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_thigh);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_thigh", d_y, 15);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_knee);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_knee", d_y, 16);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_toe);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_toe", d_y, 17);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kfs_p);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kfs_p", d_y, 18);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kfl_p);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kfl_p", d_y, 19);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kfs_d);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kfs_d", d_y, 20);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kfl_d);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kfl_d", d_y, 21);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_toe_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_toe_stand", d_y, 22);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_toe_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_toe_stand", d_y, 23);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_lateral_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_lateral_stand", d_y, 24);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_lateral_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_lateral_stand", d_y, 25);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_abduction_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_abduction_stand", d_y, 26);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_abduction_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_abduction_stand", d_y, 27);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_thigh_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_thigh_stand", d_y, 28);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_thigh_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_thigh_stand", d_y, 29);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_knee_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_knee_stand", d_y, 30);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_knee_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_knee_stand", d_y, 31);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kp_rotation_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kp_rotation_stand", d_y, 32);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.Kd_rotation_stand);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "Kd_rotation_stand", d_y, 33);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.fil_para_x);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "fil_para_x", d_y, 34);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.fil_para_y);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "fil_para_y", d_y, 35);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.stance_thre_ub);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "stance_thre_ub", d_y, 36);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.stance_thre_lb);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "stance_thre_lb", d_y, 37);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.lateral_velocity_weight);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "lateral_velocity_weight", d_y, 38);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.init_lateral_velocity);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "init_lateral_velocity", d_y, 39);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.abduction_inward_gain);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "abduction_inward_gain", d_y, 40);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.joint_filter_choice);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "joint_filter_choice", d_y, 41);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.shift_time);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "shift_time", d_y, 42);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.shift_distance);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "shift_distance", d_y, 43);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.standing_switch_time);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "standing_switch_time", d_y, 44);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.toe_tilt_angle);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "toe_tilt_angle", d_y, 45);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.final_sw_abduction);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "final_sw_abduction", d_y, 46);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.final_st_abduction);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "final_st_abduction", d_y, 47);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.pre_final_sw_abduction);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "pre_final_sw_abduction", d_y, 48);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.sagittal_offset_exp);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "sagittal_offset_exp", d_y, 49);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.lateral_offset_exp);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "lateral_offset_exp", d_y, 50);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.turning_offset_exp);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "turning_offset_exp", d_y, 51);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.stand_offset_exp);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "stand_offset_exp", d_y, 52);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.u_abduction_cp);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "u_abduction_cp", d_y, 53);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.u_abduction_swing_cp);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "u_abduction_swing_cp", d_y, 54);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.u_thigh_cp);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "u_thigh_cp", d_y, 55);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.u_knee_cp);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "u_knee_cp", d_y, 56);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.fil_para_2);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "fil_para_2", d_y, 57);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.fil_para_3);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "fil_para_3", d_y, 58);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.fil_para_4);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "fil_para_4", d_y, 59);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.fil_para_5);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "fil_para_5", d_y, 60);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.force_step_end_s);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "force_step_end_s", d_y, 61);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.sagittal_offset);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "sagittal_offset", d_y, 62);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.lateral_offset);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "lateral_offset", d_y, 63);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.turning_offset);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "turning_offset", d_y, 64);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.stand_offset);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "stand_offset", d_y, 65);
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv43, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.standing_abduction_offset);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "standing_abduction_offset", d_y, 67);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.bezier_degree);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "bezier_degree", d_y, 68);
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv44, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv45, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.stanceLeg);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "stanceLeg", d_y, 71);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.begin);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "begin", d_y, 72);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.walking_ini);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "walking_ini", d_y, 73);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.step_end);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "step_end", d_y, 74);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.task);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "task", d_y, 75);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.task_prev);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "task_prev", d_y, 76);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.task_next);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "task_next", d_y, 77);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.t0);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "t0", d_y, 78);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.t_prev);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "t_prev", d_y, 79);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.t1);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "t1", d_y, 80);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.s1);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "s1", d_y, 81);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.t2);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "t2", d_y, 82);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.s2);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "s2", d_y, 83);
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv46, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv47, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.s_prev);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "s_prev", d_y, 86);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.s_unsat_prev);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "s_unsat_prev", d_y, 87);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.dqy_b_start);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "dqy_b_start", d_y, 88);
  d_y = NULL;
  emlrtAssign(&d_y, emlrtCreateStructMatrix(1, 1, 2, sv1));
  e_y = NULL;
  m18 = emlrtCreateNumericArray(2, iv48, mxDOUBLE_CLASS, mxREAL);
  b_pData = (real_T (*)[60])emlrtMxGetPr(m18);
  for (i = 0; i < 6; i++) {
  ...
  e_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.gaitparams.ct);
  emlrtAssign(&e_y, m18);
  emlrtSetFieldR2017b(d_y, 0, "ct", e_y, 1);
  emlrtSetFieldR2017b(c_y, 0, "gaitparams", d_y, 89);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.foot_placement);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "foot_placement", d_y, 90);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.pitch_torso_control);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "pitch_torso_control", d_y, 91);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.roll_torso_control);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "roll_torso_control", d_y, 92);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.stance_passive);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "stance_passive", d_y, 93);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.knee_com);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "knee_com", d_y, 94);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.abduction_com);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "abduction_com", d_y, 95);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.thigh_compensation);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "thigh_compensation", d_y, 96);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.abduction_swing_com);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "abduction_swing_com", d_y, 97);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.keep_direction);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "keep_direction", d_y, 98);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.to_turn);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "to_turn", d_y, 99);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.to_turn_prev);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "to_turn_prev", d_y, 100);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.tg_yaw);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "tg_yaw", d_y, 101);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.tg_velocity_x);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "tg_velocity_x", d_y, 102);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.uHip_gravity_2);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "uHip_gravity_2", d_y, 103);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.dqx_b_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "dqx_b_fil", d_y, 104);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.dqy_b_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "dqy_b_fil", d_y, 105);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.dqz_b_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "dqz_b_fil", d_y, 106);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.dqx_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "dqx_fil", d_y, 107);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.dqy_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "dqy_fil", d_y, 108);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.dqz_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "dqz_fil", d_y, 109);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.com_vel_x_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "com_vel_x_fil", d_y, 110);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.com_vel_y_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "com_vel_y_fil", d_y, 111);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.com_vel_z_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "com_vel_z_fil", d_y, 112);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.com_pos_x_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "com_pos_x_fil", d_y, 113);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.com_pos_y_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "com_pos_y_fil", d_y, 114);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.com_pos_z_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "com_pos_z_fil", d_y, 115);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.pitch_des_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "pitch_des_fil", d_y, 116);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.tg_velocity_x_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "tg_velocity_x_fil", d_y, 117);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.lateral_move_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "lateral_move_fil", d_y, 118);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.LL_des_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "LL_des_fil", d_y, 119);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.roll_des_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "roll_des_fil", d_y, 120);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.P_feedback_toe_fil);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "P_feedback_toe_fil", d_y, 121);
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv49, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv50, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv51, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv52, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv53, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv54, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv55, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv56, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv57, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv58, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv59, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv60, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv61, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv62, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 10; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateNumericArray(1, iv63, mxDOUBLE_CLASS, mxREAL);
  pData = (real_T *)emlrtMxGetPr(m18);
  for (i = 0; i < 2; i++) {
  ...
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.v_final_avgy);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "v_final_avgy", d_y, 137);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.tp_last);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "tp_last", d_y, 138);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.lateral_move);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "lateral_move", d_y, 139);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.rotation_move);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "rotation_move", d_y, 140);
  d_y = NULL;
  m18 = emlrtCreateDoubleScalar(moduleInstance->sysobj.to_stand_step_count);
  emlrtAssign(&d_y, m18);
  emlrtSetFieldR2017b(c_y, 0, "to_stand_step_count", d_y, 141);
  emlrtSetCell(b_y, 0, c_y);
  c_y = NULL;
  m18 = emlrtCreateLogicalScalar(moduleInstance->sysobj_not_empty);
  emlrtAssign(&c_y, m18);
  ...
  mxArray *c, emlrtMCInfo *location)
{
  ...
  pArrays[0] = b;
  pArrays[1] = c;
  return emlrtCallMATLABR2012b(sp, 1, &m22, 2, pArrays, "sprintf", true,
    location);
}
...
/* CGXE Glue Code */
static void mdlOutputs_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S, int_T tid)
{
  InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance =
    (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S)
{
  InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance =
    (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S, int_T tid)
{
  InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance =
    (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance =
    (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance =
    (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S)
{
  InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance =
    (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S)
{
  InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *moduleInstance =
    (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG *)calloc(1, sizeof
    (InstanceStruct_bGSVBK6fn1f5qyIWfGYIZG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_bGSVBK6fn1f5qyIWfGYIZG);
  ssSetmdlInitializeConditions(S, mdlInitialize_bGSVBK6fn1f5qyIWfGYIZG);
  ssSetmdlUpdate(S, mdlUpdate_bGSVBK6fn1f5qyIWfGYIZG);
  ssSetmdlTerminate(S, mdlTerminate_bGSVBK6fn1f5qyIWfGYIZG);
...
static void mdlProcessParameters_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S)
{
}

void method_dispatcher_bGSVBK6fn1f5qyIWfGYIZG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_bGSVBK6fn1f5qyIWfGYIZG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_bGSVBK6fn1f5qyIWfGYIZG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_bGSVBK6fn1f5qyIWfGYIZG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_bGSVBK6fn1f5qyIWfGYIZG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: bGSVBK6fn1f5qyIWfGYIZG.\n"
...
mxArray *cgxe_bGSVBK6fn1f5qyIWfGYIZG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_bGSVBK6fn1f5qyIWfGYIZG_fallback_info(void)
{
